...
)
{
	...
	if (_optimiserSettings.runYulOptimiser && _localVariables.empty())
	{
		...
		obj = optimizeYul(obj, dialect, _optimiserSettings, externallyUsedIdentifiers);
...
yul::Object& CompilerContext::optimizeYul(yul::Object& _object, yul::EVMDialect const& _dialect, OptimiserSettings const& _optimiserSettings, std::set<yul::YulString> const& _externalIdentifiers)
{
#ifdef SOL_OUTPUT_ASM
